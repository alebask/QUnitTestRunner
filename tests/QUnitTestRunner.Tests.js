...
QUnit.test("enabled after ctrl+shift+key", function (assert) {
    ...
    var getEnabled = QUnitTestRunner.CookieState.getEnabled;
    ...
    assert.ok(getEnabled(), "QUnitTestRunner enabled after {Ctrl+Shift+KeyCode" + String.fromCharCode(keyCode) + "}");
});
